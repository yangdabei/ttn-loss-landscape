...
`Classical.choice`, and replays the proofs with both Lean's kernel and Nanoda.
It checks the formal statements and proof terms, not their correspondence with
the manuscript; that correspondence received a separate author review.
