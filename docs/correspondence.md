...
| Criticality in Theorem 5.2 | `TTN.Arch.Critical`; `TTN.Arch.critical_iff_nodewiseCritical` | `TTN/Landscape/CriticalityBasic.lean` | Exact | Defined by zero Fréchet derivative; proved equivalent to the nodewise residual-pairing characterization. |
